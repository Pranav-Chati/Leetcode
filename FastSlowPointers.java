public class FastSlowPointers {
    ...
    public static int calculateHappyNumber(int num) {
        int sum = 0;
    ...
    public static ListNode rearrangeLL(ListNode head) {
        ...
        // reverse afer the middle
        ListNode secondHalf = reverse(middle.next);
        middle.next = null;

        // then add to new new list
        ListNode firstHalf = head;
        while (firstHalf != null && secondHalf != null) {
            ListNode newNode = new ListNode(secondHalf.value);
            newNode.next = firstHalf.next;
